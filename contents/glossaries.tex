...
% \newglossaryentry{机器学习}{
%   name={\emph{Machine learning}},
%   description={机器学习}
% }

\newglossaryentry{pac}{
  name={概率近似正确},
  description={\emph{Probably Approximately Correct, PAC}},
  sort={gl}
}
...
% \newglossaryentry{概率近似正确}{
%   name={\emph{Probably Approximately Correct, PAC}},
%   description={概率近似正确}
% }
\newglossaryentry{erm}{
  name={经验风险最小化},
  description={\emph{Empirical Risk Minimization}},
  sort={jy}
}
...
\newglossaryentry{knowledge-base2}{
  name={Knowledge Base},
  description={知识库}
}
